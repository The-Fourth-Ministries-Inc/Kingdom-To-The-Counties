/* K2C Ambassador Companion — service worker (v18)
   ...
   and images keeps loading. API calls (/.netlify/*) are never intercepted:
   live sync simply fails over to the app's built-in demo/offline handling. */
var CACHE = "k2c-v18";
var PRECACHE = [
  "./",
  "index.html",
